...
void createSharedHeaders(String nitroNativePath, {String baseDir = '.'}) {
  ...
  for (final headerName in ['dart_api_dl.h', 'dart_api.h', 'dart_native_api.h', 'dart_version.h', 'nitro_wasm_compat.h', 'nitro_background.h', 'nitro_completion_batch.h', 'nitro_worker_pool.h']) {
