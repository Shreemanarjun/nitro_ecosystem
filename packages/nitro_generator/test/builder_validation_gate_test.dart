  ...
  functions: [
    BridgeFunction(
      ...
      params: [
        BridgeParam(
          name: 'meta',
          // Map<bool, V> — bool is not a valid key type → E001.
          // (int and enum keys are allowed since Gap #3; bool is not.)
          type: BridgeType(name: 'Map<bool, String>', isRecord: true, isMap: false),
        ),
      ],
    ),
  ],
