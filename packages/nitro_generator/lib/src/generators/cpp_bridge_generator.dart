...
class CppBridgeGenerator {
  ...
  static String _generateCppDirect(BridgeSpec spec) {
    ...
    s.writeln('// NativeImpl: cpp — shared C++ virtual-dispatch bridge (no JNI / Swift).');
    if (cppAppleOnly) s.writeln('#ifdef __APPLE__    // iOS + macOS');
    ...
    s.writeln('} // extern "C"');
    if (cppAppleOnly) s.writeln('#endif // __APPLE__  // iOS + macOS');
