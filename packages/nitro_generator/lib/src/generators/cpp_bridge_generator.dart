...
class CppBridgeGenerator {
  static String generate(BridgeSpec spec) {
    // When both platforms target NativeImpl.cpp, emit a lean direct-call bridge
    // (no JNI, no Swift @_cdecl forwarding) — user implements HybridX in C++.
    if (spec.isCppImpl) {
  ...
  // ── Direct C++ path (NativeImpl.cpp on both platforms) ─────────────────────
  ...
  static String _generateJniSwift(BridgeSpec spec) {
    final s = StringBuffer();
