...
class RecordGenerator {
  ...
  static String generateSwift(BridgeSpec spec) {
    ...
    for (final stName in referencedStructs) {
      ...
      for (final f in st.fields) {
        _swiftStructWriteStmt(s, f, enumNames, structNames);
      }
      s.writeln('  }');
      s.writeln('}');
      s.writeln();
  ...
  static void _swiftStructWriteStmt(StringBuffer s, BridgeField f, Set<String> enumNames, Set<String> structNames) {
    final base = f.type.name.replaceFirst('?', '');
    if (enumNames.contains(base)) {
