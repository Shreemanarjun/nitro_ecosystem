...
class DartFfiGenerator {
  ...
  static void _collectMapValueTypes(BridgeType t, Set<String> out) {
    if (!t.isMap) return;
  ...
  static String _mapTypeSuffix(String vt) {
  ...
  static void _emitMapBinaryHelpers(CodeWriter writer, String vt, BridgeSpec spec) {
  ...
  static bool _hasDoubleMapType(BridgeSpec spec) => false;
  ...
  static bool _isExpandableCallbackStruct(BridgeStruct st) {
