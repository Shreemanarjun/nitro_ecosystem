...
class NitroNullableInt {
  ...
  static NitroNullableInt fromReader(RecordReaderBase r) => NitroNullableInt(hasValue: r.readBool(), value: r.readInt());
...
class NitroNullableDouble {
  ...
  static NitroNullableDouble fromReader(RecordReaderBase r) => NitroNullableDouble(hasValue: r.readBool(), value: r.readDouble());
...
class NitroNullableBool {
  ...
  static NitroNullableBool fromReader(RecordReaderBase r) => NitroNullableBool(hasValue: r.readBool(), value: r.readBool());
