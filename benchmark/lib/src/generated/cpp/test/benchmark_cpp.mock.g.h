...
class MockBenchmarkCpp : public HybridBenchmarkCpp {
    ...
    MOCK_METHOD(void*, makeHandle, (), (override));
    MOCK_METHOD(int64_t, touchHandle, (void* handle), (override));
    MOCK_METHOD(int64_t, touchHandleFast, (void* handle), (override));
    ...
    MOCK_METHOD(int64_t, asyncEchoPool, (int64_t value), (override));
    MOCK_METHOD(int64_t, nativeAsyncEcho, (int64_t value), (override));
    MOCK_METHOD(int64_t, nativeAsyncEchoInline, (int64_t value), (override));
    MOCK_METHOD(int64_t, nativeAsyncEchoInlineOr, (int64_t value), (override));
    ...
    MOCK_METHOD(void, burstPoints, (int64_t count, bool batched), (override));
    MOCK_METHOD(void, burstInts, (int64_t count, bool batched), (override));
