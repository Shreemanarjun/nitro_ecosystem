...
static jmethodID g_mid_sievePrimes_call = nullptr;
...
NITRO_EXPORT void benchmark_nitro_free(void* ptr) { if (ptr) { free(ptr); } }
NITRO_EXPORT void* benchmark_nitro_alloc(size_t size) { return malloc(size); }
...
int64_t benchmark_sieve_primes(int64_t instanceId, int64_t limit, NitroError* _nitro_err) {
    if (_nitro_err) { _nitro_err->hasError = 0; }  // S8: clear slot
    JNIEnv* env = GetEnv();
    if (env == nullptr) { return 0; }
    jmethodID methodId = g_mid_sievePrimes_call;
    if (methodId == nullptr) { LOGE("Method not found: sievePrimes_call sig=(JJ)J"); return 0; }

    benchmark_clear_error();
    int64_t res = env->CallStaticLongMethod(g_bridgeClass, methodId, (jlong)instanceId, limit);
    if (env->ExceptionCheck()) {
        env->PushLocalFrame(8);
        nitro_report_jni_exception(env, env->ExceptionOccurred(), _nitro_err);
        env->PopLocalFrame(nullptr);
...
JNIEXPORT void JNICALL Java_nitro_benchmark_1module_BenchmarkJniBridge_initialize(JNIEnv* env, jobject thiz, jclass localClass) {
    ...
    if (g_bridgeClass != nullptr) {
        ...
        g_mid_sievePrimes_call = env->GetStaticMethodID(g_bridgeClass, "sievePrimes_call", "(JJ)J");
        if (!g_mid_sievePrimes_call && env->ExceptionCheck()) { env->ExceptionClear(); LOGE("Method not found: sievePrimes_call sig=(JJ)J"); }
...
#ifdef __OBJC__
    @try {
        const char* _sw = (const char*)_benchmark_call_getGreeting(name);
...
extern int64_t _benchmark_call_sievePrimes(int64_t limit);
int64_t benchmark_sieve_primes(int64_t instanceId, int64_t limit, NitroError* _nitro_err) {
    if (_nitro_err) { _nitro_err->hasError = 0; }
#ifdef __OBJC__
    @try {
        return _benchmark_call_sievePrimes(limit);
    } @catch (NSException* e) {
        if (_nitro_err) {
            // sync: write exception to out-param error slot.
            _nitro_err->hasError = 1;
...
static std::unordered_map<int64_t, std::shared_ptr<HybridBenchmark>>& _g_instances() {
    static std::unordered_map<int64_t, std::shared_ptr<HybridBenchmark>> m;
    return m;
}
...
static HybridBenchmarkFactory& _g_factory() {
    static HybridBenchmarkFactory f;
    return f;
}
...
struct alignas(64) _NitroInstSlot {
    ...
    std::atomic<HybridBenchmark*> ptr{nullptr};
};
static _NitroInstSlot _g_inst_cache[_kNitroCacheWays];
static HybridBenchmark* _nitro_get_instance(int64_t id) {
    ...
    HybridBenchmark* p = (it != _g_instances().end()) ? it->second.get() : nullptr;
    if (p) {
...
extern "C" {
void benchmark_register_factory(void* fn) {
    _g_factory() = *static_cast<HybridBenchmarkFactory*>(fn);
}
void benchmark_register_impl(HybridBenchmark* impl) {
    std::lock_guard<std::mutex> _lk(_g_instances_mtx());
    if (impl) _g_instances()[0] = std::shared_ptr<HybridBenchmark>(impl, [](HybridBenchmark*){});
    else _g_instances().erase(0);
    _nitro_invalidate_cache();
}
HybridBenchmark* benchmark_get_impl() {
...
double benchmark_add(int64_t instanceId, double a, double b, NitroError* _nitro_err) {
    ...
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call benchmark_register_impl() first."); return 0.0; }
    try {
...
const char* benchmark_get_greeting(int64_t instanceId, const char* name, NitroError* _nitro_err) {
    ...
    if (_nitro_err) { _nitro_err->hasError = 0; }  // S8: clear slot
    auto _impl = _nitro_get_instance(instanceId);
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call benchmark_register_impl() first."); return nullptr; }
    try {
...
int64_t benchmark_hash_buffer(int64_t instanceId, uint8_t* data, size_t data_length, int64_t rounds, NitroError* _nitro_err) {
    ...
    if (_nitro_err) { _nitro_err->hasError = 0; }  // S8: clear slot
    auto _impl = _nitro_get_instance(instanceId);
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call benchmark_register_impl() first."); return 0; }
    try {
...
int64_t benchmark_send_large_buffer(int64_t instanceId, uint8_t* buffer, size_t buffer_length, NitroError* _nitro_err) {
    ...
    if (!_impl) { _nitro_desktop_err(_nitro_err, "NotInitialized", "No C++ implementation registered. Call benchmark_register_impl() first."); return 0; }
    try {
        return _impl->sendLargeBuffer(buffer, static_cast<size_t>(buffer_length));
    } catch (const std::exception& e) {
        _nitro_desktop_err(_nitro_err, "CppException", e.what());
        return 0;
    } catch (...) {
