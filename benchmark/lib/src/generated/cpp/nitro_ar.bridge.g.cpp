...
NITRO_EXPORT void nitro_ar_nitro_free(void* ptr) { if (ptr) { free(ptr); } }
...
void* nitro_ar_detect_package(int64_t instanceId, void* rect, NitroError* _nitro_err) {
    ...
    static thread_local PackageDimensions _g_ret_st;
    PackageDimensions* result = &_g_ret_st;
...
void* nitro_ar_get_raw_depth_map(int64_t instanceId, NitroError* _nitro_err) {
    ...
    static thread_local RawDepthMap _g_ret_st;
    RawDepthMap* result = &_g_ret_st;
...
void nitro_ar_register_detected_packages_stream(int64_t instanceId, int64_t dart_port) {
    ...
    g_nitro_batch_nitro_ar.coalesce(dart_port, [](int64_t a) { nitro_ar_nitro_free((void*)(intptr_t)a); });
...
void nitro_ar_release_detected_packages_stream(int64_t dart_port) {
    ...
    g_nitro_batch_nitro_ar.uncoalesce(dart_port);
}
