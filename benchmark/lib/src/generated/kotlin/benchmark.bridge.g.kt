...
object BenchmarkJniBridge {
    ...
    @JvmStatic fun sendLargeBuffer_call(buffer: ByteArray): Long {
        val impl = implementation ?: throw IllegalStateException("Benchmark not registered")
    ...
    @JvmStatic fun benchmark_register_data_stream_stream_call(dartPort: Long) {
    ...
    @JvmStatic fun benchmark_release_data_stream_stream_call(dartPort: Long) {
    ...
    @JvmStatic fun benchmark_register_box_stream_stream_call(dartPort: Long) {
        val impl = implementation ?: return
    ...
    @JvmStatic fun benchmark_release_box_stream_stream_call(dartPort: Long) {
