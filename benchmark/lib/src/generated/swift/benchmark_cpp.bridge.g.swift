...
public protocol HybridBenchmarkCppProtocol: AnyObject {
    ...
    func makeHandle() -> Any
    func touchHandle(handle: Any) -> Int64
    func touchHandleFast(handle: Any) -> Int64
    ...
    func asyncEchoPool(value: Int64) async throws -> Int64
    func nativeAsyncEcho(value: Int64) async throws -> Int64
    func nativeAsyncEchoInline(value: Int64) -> Int64
    func nativeAsyncEchoInlineOr(value: Int64) -> Int64
    func nativeAsyncEchoFromThread(value: Int64) async throws -> Int64
    func submitCoalesced(callId: Int64, value: Int64, dartPort: Int64) -> Void
    func resetCoalesceStats() -> Void
    func coalesceFlushes() -> Int64
    func coalesceItems() -> Int64
    func burstPoints(count: Int64, batched: Bool) -> Void
    func burstInts(count: Int64, batched: Bool) -> Void
    ...
    var pointBurstPerItem: AnyPublisher<BenchmarkPoint, Never> { get }
    var pointBurstBatched: AnyPublisher<BenchmarkPoint, Never> { get }
    var intBurstPerItem: AnyPublisher<Int64, Never> { get }
    var intBurstBatched: AnyPublisher<Int64, Never> { get }
...
public class BenchmarkCppRegistry {
    ...
    // Stream: pointBurstPerItem cancellables keyed by dartPort
    public static var _pointBurstPerItemCancellables = [Int64: AnyCancellable]()

    // Stream: pointBurstBatched cancellables keyed by dartPort
    public static var _pointBurstBatchedCancellables = [Int64: AnyCancellable]()

    // Stream: intBurstPerItem cancellables keyed by dartPort
    public static var _intBurstPerItemCancellables = [Int64: AnyCancellable]()

    // Stream: intBurstBatched cancellables keyed by dartPort
    public static var _intBurstBatchedCancellables = [Int64: AnyCancellable]()
