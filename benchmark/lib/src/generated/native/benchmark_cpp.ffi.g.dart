...
class _BenchmarkCppImpl extends BenchmarkCpp {
  ...
  late final int Function(int, int) _asyncEchoPtr = _dylib
      .lookupFunction<Int64 Function(Int64, Int64), int Function(int, int)>(
        'benchmark_cpp_async_echo',
      );
  late final void Function(int, int, Pointer<NitroErrorFfi>, int)
  ...
  Future<BenchmarkStats> computeStats(int iterations) async {
    ...
    try {
      decoded = BenchmarkStatsRecordFfiExt.fromNative(rawPtr);
    } finally {
      _nitroFree(rawPtr);
    }
    return decoded;
